...
# Replacement policy, implement queue, serial queue, queue length, queue cycles % of typical
configurations = [("LRU", 0, 0, 1, 1), 
                  ("LRU", 1, 0, 4, 80), ("LRU", 1, 0, 4, 100), ("LRU", 1, 0, 4, 120), ("LRU", 1, 0, 4, 150), ("LRU", 1, 0, 4, 200), 
                  ("LRU", 1, 0, 8, 80), ("LRU", 1, 0, 8, 100), ("LRU", 1, 0, 8, 120), ("LRU", 1, 0, 8, 150), ("LRU", 1, 0, 4, 200), 
                  ("LRU", 1, 0, 16, 80), ("LRU", 1, 0, 16, 100), ("LRU", 1, 0, 16, 120), ("LRU", 1, 0, 16, 150), ("LRU", 1, 0, 16, 200), 
                  ("LRU", 1, 0, 32, 80), ("LRU", 1, 0, 32, 100), ("LRU", 1, 0, 32, 120), ("LRU", 1, 0, 32, 150), ("LRU", 1, 0, 32, 200), 
                  ("LRU", 1, 1, 4, 80), ("LRU", 1, 1, 4, 100), ("LRU", 1, 1, 4, 120), ("LRU", 1, 1, 4, 150), ("LRU", 1, 1, 4, 200), 
                  ("LRU", 1, 1, 8, 80), ("LRU", 1, 1, 8, 100), ("LRU", 1, 1, 8, 120), ("LRU", 1, 1, 8, 150), ("LRU", 1, 1, 8, 200), 
                  ("LRU", 1, 1, 16, 80), ("LRU", 1, 1, 16, 100), ("LRU", 1, 1, 16, 120), ("LRU", 1, 1, 16, 150), ("LRU", 1, 1, 16, 200), 
                  ("LRU", 1, 1, 32, 80), ("LRU", 1, 1, 32, 100), ("LRU", 1, 1, 32, 120), ("LRU", 1, 1, 32, 150), ("LRU", 1, 1, 32, 200), 
                  ("MOCKINGJAY", 0, 0, 1, 1), 
                  ("MOCKINGJAY", 1, 0, 4, 80), ("MOCKINGJAY", 1, 0, 4, 100), ("MOCKINGJAY", 1, 0, 4, 120), ("MOCKINGJAY", 1, 0, 4, 150), ("MOCKINGJAY", 1, 0, 4, 200), 
                  ("MOCKINGJAY", 1, 0, 8, 80), ("MOCKINGJAY", 1, 0, 8, 100), ("MOCKINGJAY", 1, 0, 8, 120), ("MOCKINGJAY", 1, 0, 8, 150), ("MOCKINGJAY", 1, 0, 8, 200), 
                  ("MOCKINGJAY", 1, 0, 16, 80), ("MOCKINGJAY", 1, 0, 16, 100), ("MOCKINGJAY", 1, 0, 16, 120), ("MOCKINGJAY", 1, 0, 16, 150), ("MOCKINGJAY", 1, 0, 16, 200), 
                  ("MOCKINGJAY", 1, 0, 32, 80), ("MOCKINGJAY", 1, 0, 32, 100), ("MOCKINGJAY", 1, 0, 32, 120), ("MOCKINGJAY", 1, 0, 32, 150), ("MOCKINGJAY", 1, 0, 32, 200), 
                  ("MOCKINGJAY", 1, 1, 4, 80), ("MOCKINGJAY", 1, 1, 4, 100), ("MOCKINGJAY", 1, 1, 4, 120), ("MOCKINGJAY", 1, 1, 4, 150), ("MOCKINGJAY", 1, 1, 4, 200), 
                  ("MOCKINGJAY", 1, 1, 8, 80), ("MOCKINGJAY", 1, 1, 8, 100), ("MOCKINGJAY", 1, 1, 8, 120), ("MOCKINGJAY", 1, 1, 8, 150), ("MOCKINGJAY", 1, 1, 8, 200), 
                  ("MOCKINGJAY", 1, 1, 16, 80), ("MOCKINGJAY", 1, 1, 16, 100), ("MOCKINGJAY", 1, 1, 16, 120), ("MOCKINGJAY", 1, 1, 16, 150), ("MOCKINGJAY", 1, 1, 16, 200), 
                  ("MOCKINGJAY", 1, 1, 32, 80), ("MOCKINGJAY", 1, 1, 32, 100), ("MOCKINGJAY", 1, 1, 32, 120), ("MOCKINGJAY", 1, 1, 32, 150), ("MOCKINGJAY", 1, 1, 32, 200), 
				  ("HAWKEYE", 0, 0, 1, 1), 
                  ("HAWKEYE", 1, 0, 4, 80), ("HAWKEYE", 1, 0, 4, 100), ("HAWKEYE", 1, 0, 4, 120), ("HAWKEYE", 1, 0, 4, 150), ("HAWKEYE", 1, 0, 4, 200), 
                  ("HAWKEYE", 1, 0, 8, 80), ("HAWKEYE", 1, 0, 8, 100), ("HAWKEYE", 1, 0, 8, 120), ("HAWKEYE", 1, 0, 8, 150), ("HAWKEYE", 1, 0, 8, 200), 
                  ("HAWKEYE", 1, 0, 16, 80), ("HAWKEYE", 1, 0, 16, 100), ("HAWKEYE", 1, 0, 16, 120), ("HAWKEYE", 1, 0, 16, 150), ("HAWKEYE", 1, 0, 16, 200), 
                  ("HAWKEYE", 1, 0, 32, 80), ("HAWKEYE", 1, 0, 32, 100), ("HAWKEYE", 1, 0, 32, 120), ("HAWKEYE", 1, 0, 32, 150), ("HAWKEYE", 1, 0, 32, 200), 
                  ("HAWKEYE", 1, 1, 4, 80), ("HAWKEYE", 1, 1, 4, 100), ("HAWKEYE", 1, 1, 4, 120), ("HAWKEYE", 1, 1, 4, 150), ("HAWKEYE", 1, 1, 4, 200), 
                  ("HAWKEYE", 1, 1, 8, 80), ("HAWKEYE", 1, 1, 8, 100), ("HAWKEYE", 1, 1, 8, 120), ("HAWKEYE", 1, 1, 8, 150), ("HAWKEYE", 1, 1, 8, 200), 
                  ("HAWKEYE", 1, 1, 16, 80), ("HAWKEYE", 1, 1, 16, 100), ("HAWKEYE", 1, 1, 16, 120), ("HAWKEYE", 1, 1, 16, 150), ("HAWKEYE", 1, 1, 16, 200), 
                  ("HAWKEYE", 1, 1, 32, 80), ("HAWKEYE", 1, 1, 32, 100), ("HAWKEYE", 1, 1, 32, 120), ("HAWKEYE", 1, 1, 32, 150), ("HAWKEYE", 1, 1, 32, 200), 
                  ("DRRIP", 0, 0, 1, 1), 
                  ("DRRIP", 1, 0, 4, 80), ("DRRIP", 1, 0, 4, 100), ("DRRIP", 1, 0, 4, 120), ("DRRIP", 1, 0, 4, 150), ("DRRIP", 1, 0, 4, 200), 
                  ("DRRIP", 1, 0, 8, 80), ("DRRIP", 1, 0, 8, 100), ("DRRIP", 1, 0, 8, 120), ("DRRIP", 1, 0, 8, 150), ("DRRIP", 1, 0, 8, 200), 
                  ("DRRIP", 1, 0, 16, 80), ("DRRIP", 1, 0, 16, 100), ("DRRIP", 1, 0, 16, 120), ("DRRIP", 1, 0, 16, 150), ("DRRIP", 1, 0, 16, 200), 
                  ("DRRIP", 1, 0, 32, 80), ("DRRIP", 1, 0, 32, 100), ("DRRIP", 1, 0, 32, 120), ("DRRIP", 1, 0, 32, 150), ("DRRIP", 1, 0, 32, 200), 
                  ("DRRIP", 1, 1, 4, 80), ("DRRIP", 1, 1, 4, 100), ("DRRIP", 1, 1, 4, 120), ("DRRIP", 1, 1, 4, 150), ("DRRIP", 1, 1, 4, 200), 
                  ("DRRIP", 1, 1, 8, 80), ("DRRIP", 1, 1, 8, 100), ("DRRIP", 1, 1, 8, 120), ("DRRIP", 1, 1, 8, 150), ("DRRIP", 1, 1, 8, 200), 
                  ("DRRIP", 1, 1, 16, 80), ("DRRIP", 1, 1, 16, 100), ("DRRIP", 1, 1, 16, 120), ("DRRIP", 1, 1, 16, 150), ("DRRIP", 1, 1, 16, 200), 
                  ("DRRIP", 1, 1, 32, 80), ("DRRIP", 1, 1, 32, 100), ("DRRIP", 1, 1, 32, 120), ("DRRIP", 1, 1, 32, 150), ("DRRIP", 1, 1, 32, 200), 
				  ("SHIP", 0, 0, 1, 1), 
                  ("SHIP", 1, 0, 4, 80), ("SHIP", 1, 0, 4, 100), ("SHIP", 1, 0, 4, 120), ("SHIP", 1, 0, 4, 150), ("SHIP", 1, 0, 4, 200), 
                  ("SHIP", 1, 0, 8, 80), ("SHIP", 1, 0, 8, 100), ("SHIP", 1, 0, 8, 120), ("SHIP", 1, 0, 8, 150), ("SHIP", 1, 0, 8, 200), 
                  ("SHIP", 1, 0, 16, 80), ("SHIP", 1, 0, 16, 100), ("SHIP", 1, 0, 16, 120), ("SHIP", 1, 0, 16, 150), ("SHIP", 1, 0, 16, 200), 
                  ("SHIP", 1, 0, 32, 80), ("SHIP", 1, 0, 32, 100), ("SHIP", 1, 0, 32, 120), ("SHIP", 1, 0, 32, 150), ("SHIP", 1, 0, 32, 200), 
                  ("SHIP", 1, 1, 4, 80), ("SHIP", 1, 1, 4, 100), ("SHIP", 1, 1, 4, 120), ("SHIP", 1, 1, 4, 150), ("SHIP", 1, 1, 4, 200), 
                  ("SHIP", 1, 1, 8, 80), ("SHIP", 1, 1, 8, 100), ("SHIP", 1, 1, 8, 120), ("SHIP", 1, 1, 8, 150), ("SHIP", 1, 1, 8, 200), 
                  ("SHIP", 1, 1, 16, 80), ("SHIP", 1, 1, 16, 100), ("SHIP", 1, 1, 16, 120), ("SHIP", 1, 1, 16, 150), ("SHIP", 1, 1, 16, 200), 
                  ("SHIP", 1, 1, 32, 80), ("SHIP", 1, 1, 32, 100), ("SHIP", 1, 1, 32, 120), ("SHIP", 1, 1, 32, 150), ("SHIP", 1, 1, 32, 200), 
                #   ("PERCEPTRON", 0, 0, 1, 1), 
                #   ("PERCEPTRON", 1, 0, 4, 80), ("PERCEPTRON", 1, 0, 4, 100), ("PERCEPTRON", 1, 0, 4, 120), ("PERCEPTRON", 1, 0, 4, 150), ("PERCEPTRON", 1, 0, 4, 200), 
                #   ("PERCEPTRON", 1, 0, 8, 80), ("PERCEPTRON", 1, 0, 8, 100), ("PERCEPTRON", 1, 0, 8, 120), ("PERCEPTRON", 1, 0, 8, 150), ("PERCEPTRON", 1, 0, 8, 200), 
                #   ("PERCEPTRON", 1, 0, 16, 80), ("PERCEPTRON", 1, 0, 16, 100), ("PERCEPTRON", 1, 0, 16, 120), ("PERCEPTRON", 1, 0, 16, 150), ("PERCEPTRON", 1, 0, 16, 200), 
                #   ("PERCEPTRON", 1, 0, 32, 80), ("PERCEPTRON", 1, 0, 32, 100), ("PERCEPTRON", 1, 0, 32, 120), ("PERCEPTRON", 1, 0, 32, 150), ("PERCEPTRON", 1, 0, 32, 200), 
                #   ("PERCEPTRON", 1, 1, 4, 80), ("PERCEPTRON", 1, 1, 4, 100), ("PERCEPTRON", 1, 1, 4, 120), ("PERCEPTRON", 1, 1, 4, 150), ("PERCEPTRON", 1, 1, 4, 200), 
                #   ("PERCEPTRON", 1, 1, 8, 80), ("PERCEPTRON", 1, 1, 8, 100), ("PERCEPTRON", 1, 1, 8, 120), ("PERCEPTRON", 1, 1, 8, 150), ("PERCEPTRON", 1, 1, 8, 200), 
                #   ("PERCEPTRON", 1, 1, 16, 80), ("PERCEPTRON", 1, 1, 16, 100), ("PERCEPTRON", 1, 1, 16, 120), ("PERCEPTRON", 1, 1, 16, 150), ("PERCEPTRON", 1, 1, 16, 200), 
                #   ("PERCEPTRON", 1, 1, 32, 80), ("PERCEPTRON", 1, 1, 32, 100), ("PERCEPTRON", 1, 1, 32, 120), ("PERCEPTRON", 1, 1, 32, 150), ("PERCEPTRON", 1, 1, 32, 200), 
				  ("RANDOM", 0, 0, 1, 1), 
                  ("RANDOM", 1, 0, 4, 80), ("RANDOM", 1, 0, 4, 100), ("RANDOM", 1, 0, 4, 120), ("RANDOM", 1, 0, 4, 150), ("RANDOM", 1, 0, 4, 200), 
                  ("RANDOM", 1, 0, 8, 80), ("RANDOM", 1, 0, 8, 100), ("RANDOM", 1, 0, 8, 120), ("RANDOM", 1, 0, 8, 150), ("RANDOM", 1, 0, 8, 200), 
                  ("RANDOM", 1, 0, 16, 80), ("RANDOM", 1, 0, 16, 100), ("RANDOM", 1, 0, 16, 120), ("RANDOM", 1, 0, 16, 150), ("RANDOM", 1, 0, 16, 200), 
                  ("RANDOM", 1, 0, 32, 80), ("RANDOM", 1, 0, 32, 100), ("RANDOM", 1, 0, 32, 120), ("RANDOM", 1, 0, 32, 150), ("RANDOM", 1, 0, 32, 200), 
                  ("RANDOM", 1, 1, 4, 80), ("RANDOM", 1, 1, 4, 100), ("RANDOM", 1, 1, 4, 120), ("RANDOM", 1, 1, 4, 150), ("RANDOM", 1, 1, 4, 200), 
                  ("RANDOM", 1, 1, 8, 80), ("RANDOM", 1, 1, 8, 100), ("RANDOM", 1, 1, 8, 120), ("RANDOM", 1, 1, 8, 150), ("RANDOM", 1, 1, 8, 200), 
                  ("RANDOM", 1, 1, 16, 80), ("RANDOM", 1, 1, 16, 100), ("RANDOM", 1, 1, 16, 120), ("RANDOM", 1, 1, 16, 150), ("RANDOM", 1, 1, 16, 200), 
                  ("RANDOM", 1, 1, 32, 80), ("RANDOM", 1, 1, 32, 100), ("RANDOM", 1, 1, 32, 120), ("RANDOM", 1, 1, 32, 150), ("RANDOM", 1, 1, 32, 200), 
				 ]
